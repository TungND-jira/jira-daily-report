...
# Các JQL filter
filters = {
    "🔥 Bug impact lớn": 'project = "KV Retail" AND status in (Done, Rollback) AND type = "Release plan" AND summary ~ "All"',
    "🤬 Customer Push": 'project = "KV Retail" and labels = KVR_Technical'
}
